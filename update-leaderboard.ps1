...
$jsonTradeFlair.'JSON_OBJECTAGG(Username,TradeFlair)' | set-content -Path .\tradeCountDisplay\trade_flair.json
aws s3 cp .\tradeCountDisplay\trade_flair.json s3://ccautoflair.bitbinder.net/trade_flair.json